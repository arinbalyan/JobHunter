...
## Next Steps
- Read `002-Plugin-System.md` to understand how to add custom bots
- Read `003-Email-Tracking.md` to understand the tracking architecture
- Read `004-LLM-Router.md` to understand provider routing
